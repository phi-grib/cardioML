...
- EFTPC_IC50_28_CiPADrugs.xlsx: This file contains D, $IC_{50}$ and hill coefficient for calculate the input values for CiPA compounds of the previous excel file.
