%     Ventricular action potential model ORdmJ
%     Copyright (C) 2020 Jordi Llopis. Contact: jorllolo@etsii.upv.es

function output=ORdmD(t,X,flag_ode, Kr_effect, Ks_effect, NaL_effect, cellType)
% cellType values: 'endo', 'epi', 'mid'
switch cellType
    case 'endo'
        celltype=0;
    case 'epi'
    ...
    case 'mid'
        celltype=2;
    otherwise
        error('Celltype must be: ''endo'', ''epi'' or ''mid''')
end
...
dhLp=(hLssp-hLp)/thLp;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
GNaL=0.0075*INaL_factor*NaL_effect;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if celltype==1
    GNaL=GNaL*0.6;
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
GKr=0.046*IKr_factor*Kr_effect;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if celltype==1
    GKr=GKr*1.3;
elseif celltype==2
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
GKs=0.0034*IKs_factor*Ks_effect;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if celltype==1
    GKs=GKs*1.4;
end
